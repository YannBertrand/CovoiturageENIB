			...
			<div class="postcontent">
				<?php if($show_map) { ?>
					<form action="" method="post">
						...
						<p id="step_1">Je cherche un trajet de <span id="from">...</span> à <span id="to">...</span><span id="end_step_1" style="display: none;">...<span></p>
						...
						<p id="step_3" style="display: none;" onChange="showHide('step_4', 'end_step_3')">
							...tou(te)s les 
